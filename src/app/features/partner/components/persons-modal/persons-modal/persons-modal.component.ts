...
@Component({
  ...
  standalone: true,
  imports: [FormsModule, LucideAngularModule, MatTooltipModule, PsInputComponent, ModalPersonCardComponent, PhotoLightboxComponent, DialogWrapperComponent, LayoutPhotoUploadDialogComponent, ConfirmDialogComponent, BatchPortraitDialogComponent, TeacherLinkDialogComponent, TeacherPhotoChooserDialogComponent],
