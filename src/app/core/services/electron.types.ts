...
interface PhotoshopAPI {
  ...
  checkPsdExists: (params: { psdPath: string }) => Promise<{ success: boolean; exists: boolean; hasLayouts: boolean; hasPlacedPhotos: boolean; placedPhotos: Record<string, number> | null }>;
  findProjectPsd: (params: { folderPath: string }) => Promise<{ success: boolean; exists: boolean; psdPath?: string; hasLayouts?: boolean; hasPlacedPhotos?: boolean; placedPhotos?: Record<string, number> | null }>;
